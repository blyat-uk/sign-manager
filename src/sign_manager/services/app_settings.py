...
from sign_manager.services.hardware_profile import HardwareProfile, detect
...
def _settings_path() -> Path:
    ...
    ``~/.config/sign-manager/settings.json``.
    """
    ...
    return Path(os.path.expanduser("~/.config")) / APP_SLUG / "settings.json"
